...
import 'package:app/utils/ApiClient.dart';
import 'package:app/utils/RequestConfig.dart';
import 'package:app/utils/rtc_ice_candidate.dart';
...
class Signaling {
  ...
  void close() {
    ...
    _localStream = null;
    _timer?.cancel();
    _sendJson(JsonConstants.leaveRoom, {});
  ...
  Future<void> connect() async {
    try {
      ...
      _socket!.listen((data) {
        print("💁🏼‍♀️💁🏼‍♀️💁🏼‍♀️ 소켓 Listen ::: ${json.decode(data)}");
      ...
      _createLocalPeerConnection().then((_) {
        print("💁🏼‍♀️💁🏼‍♀️💁🏼‍♀️ local peer connection 함수 그 후....");
  ...
  void _saveIceCandidate(Map<String, dynamic> params, String endpointName,
    ...
    RTCIceCandidate iceCandidate = RTCIceCandidate(
        params['candidate'], params['sdpMid'], params['sdpMLineIndex']);
  ...
  Future<void> _createLocalOffer() async {
    try {
      print("💁🏼‍♀️💁🏼‍♀️💁🏼‍♀️ createLocalOffer 시도중!!!....");
      ...
      print("💁🏼‍♀️💁🏼‍♀️💁🏼‍♀️ rtc description 만들고!!!....");
    } catch (e) {
      print("💩💩💩 _createLocalOffer 에러!!!....");
      print(e.toString());
    }
  }
